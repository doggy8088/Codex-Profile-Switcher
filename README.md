...
```sh
brew tap doggy8088/codex-profile-switcher https://github.com/doggy8088/Codex-Profile-Switcher && brew trust doggy8088/codex-profile-switcher && brew install --cask codex-profile-switcher
```

Homebrew cask 會下載 `CodexProfilesSwitcher.dmg`，並把應用程式安裝為 `/Applications/CodexProfileSwitcher.app`。此 DMG 應由 Developer ID 簽署、完成 Apple 公證並 staple；cask 不再移除 macOS quarantine 屬性。
